...
prevent). Eighteen review rounds (review IDs `0005`–`0022`, all recorded in the consolidated `gate-reviews/0005` record — seventeen independent cold-pass reviews and one author self-red-team round) drove this scope. This section,
