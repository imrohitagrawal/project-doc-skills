...
- Diff range: e4bc544..HEAD (current head; the PR has been reviewed over SIXTEEN rounds — see below)
...
- Reviewers / instruments: **sixteen independent review rounds**. Rounds 1–11 paired a same-model
...
**Why this record is nevertheless BLOCK:** the most recent independent review (round 16) returned BLOCK,
...
independent round-17 review (a different-vendor cold pass, per the Independence note above) examines the
